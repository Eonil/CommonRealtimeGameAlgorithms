...
// reduction is not due to guarantee of stability.
// 
// @param
// LEN
// Maximum total item count. 
// If this is not a multiplication of `PACK`, then a few of memory will be wasted.
// 
// @param
// PACK
// Dynamic memory allocation unit.
// */
//template <typename T, Size const LEN, Size const PACK>
//class
//DynamicStableOrderlessSet
//{
//public:
//private:
//	
//	StaticStableListStack<<#typename T#>, <#Size LEN#>>
//	StaticStableOrderlessSet<T, PACK>;
//};
//
//
//
